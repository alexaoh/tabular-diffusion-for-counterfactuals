...
def main(args):
    ...
    # python TVAE/generate_data_AD.py -s 1234 -d AD -t True -g True -T 1000 -e 200 -b 256 --mlp-blocks 256 1024 1024 1024 1024 256 --dropout-ps 0 0 0 0 0 0 --early-stop-tolerance "None" --num-samples 10000 --savename "TVAE_K10000_"
        
    # Load the generated possible counterfactuals, Dh, from disk. 
    cfs = pd.read_csv("synthetic_data/AD_TVAE_K"+str(args.K)+"_"+str(args.seed)+".csv", index_col = 0)
    ...
    cfs.to_csv("counterfactuals/AD_TVAE_final_K"+str(args.K)+"_"+str(seed)+".csv")
