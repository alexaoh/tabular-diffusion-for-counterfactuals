...
def take_args():
    ...
    parser = argparse.ArgumentParser(prog = "CH_TVAE_generate_counterfactuals.py", 
                                     description = "Generate counterfactuals for factuals in CH with TVAE.")
...
def main(args):
    ...
    # python TVAE/generate_data_CH.py -s 1234 -d CH -t True -g True -T 1000 -e 200 -b 256 --mlp-blocks 256 1024 1024 1024 1024 256 --dropout-ps 0 0 0 0 0 0 --early-stop-tolerance "None" --num-samples 10000 --savename "TVAE_K10000_"
        
    # Load the generated possible counterfactuals, Dh, from disk. 
    cfs = pd.read_csv("synthetic_data/CH_TVAE_K"+str(args.K)+"_"+str(args.seed)+".csv", index_col = 0)
    ...
    cfs.to_csv("counterfactuals/CH_TVAE_final_K"+str(args.K)+"_"+str(seed)+".csv")
