...
def main(args):
    ...
    if args.generate:
        ...
        cfs.to_csv("counterfactuals/CH_MCCE_Dh_K"+str(args.K)+".csv")
    else: 
        # Load the generated possible counterfactuals, Dh, from disk. 
        cfs = pd.read_csv("counterfactuals/CH_MCCE_Dh_K"+str(args.K)+".csv", index_col = 0)
    ...
    cfs.to_csv("counterfactuals/CH_MCCE_final_K"+str(args.K)+".csv")
