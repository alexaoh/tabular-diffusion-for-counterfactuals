...
def main(args):
    ...
    cfs = pd.read_csv("synthetic_data/DI_TabDDPM_K"+str(args.K)+"_"+str(args.seed)+".csv", index_col = 0)
    ...
    cfs.to_csv("counterfactuals/DI_TabDDPM_final_K"+str(args.K)+"_"+str(seed)+".csv")
