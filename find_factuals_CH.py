...
def take_args():
    ...
    parser = argparse.ArgumentParser(prog = "find_factuals_CH.py", 
                                     description = "Find factuals from CatBoost predictor on CH.")
...
def main(args):
    ...
    if args.train:
        ...
        model.save_model("predictors/cat_boost_CH"+str(seed)+".dump")
    ...
    if args.save_factuals:
        factuals.to_csv("factuals/factuals_CH_catboost"+str(seed)+".csv")
