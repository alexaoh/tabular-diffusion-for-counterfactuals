...
# Find possible counterfactuals from TabDDPM, after training the model. This finds possible counterfactuals from p(X,y).
nice python $DIR/../train_diffusion.py -s 1234 -d DI -T 1000 -e 200 -b 64 --mlp-blocks 128 512 --dropout-ps 0 0 --early-stop-tolerance 10 --dont-plot-losses --savename "TabDDPM_K10000_" --num-samples 100000 --dont-train
nice python $DIR/../train_diffusion.py -s 4500 -d DI -T 1000 -e 200 -b 64 --mlp-blocks 128 512 --dropout-ps 0 0 --early-stop-tolerance 10 --dont-plot-losses --savename "TabDDPM_K10000_" --num-samples 100000 --dont-train
nice python $DIR/../train_diffusion.py -s 2018 -d DI -T 1000 -e 200 -b 64 --mlp-blocks 128 512 --dropout-ps 0 0 --early-stop-tolerance 10 --dont-plot-losses --savename "TabDDPM_K10000_" --num-samples 100000 --dont-train
nice python $DIR/../train_diffusion.py -s 1999 -d DI -T 1000 -e 200 -b 64 --mlp-blocks 128 512 --dropout-ps 0 0 --early-stop-tolerance 10 --dont-plot-losses --savename "TabDDPM_K10000_" --num-samples 100000 --dont-train
nice python $DIR/../train_diffusion.py -s 2023 -d DI -T 1000 -e 200 -b 64 --mlp-blocks 128 512 --dropout-ps 0 0 --early-stop-tolerance 10 --dont-plot-losses --savename "TabDDPM_K10000_" --num-samples 100000 --dont-train
