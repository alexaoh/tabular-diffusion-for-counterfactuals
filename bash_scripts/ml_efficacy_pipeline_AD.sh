...
nice python $DIR/../train_diffusion.py -s 1234 -d AD -t True -g True -T 1000 -b 256 --mlp-blocks 256 1024 1024 1024 1024 256 --dropout-ps 0 0 0 0 0 0
nice python $DIR/../train_diffusion.py -s 4500 -d AD -t True -g True -T 1000 -b 256 --mlp-blocks 256 1024 1024 1024 1024 256 --dropout-ps 0 0 0 0 0 0
nice python $DIR/../train_diffusion.py -s 2018 -d AD -t True -g True -T 1000 -b 256 --mlp-blocks 256 1024 1024 1024 1024 256 --dropout-ps 0 0 0 0 0 0
nice python $DIR/../train_diffusion.py -s 1999 -d AD -t True -g True -T 1000 -b 256 --mlp-blocks 256 1024 1024 1024 1024 256 --dropout-ps 0 0 0 0 0 0
nice python $DIR/../train_diffusion.py -s 2023 -d AD -t True -g True -T 1000 -b 256 --mlp-blocks 256 1024 1024 1024 1024 256 --dropout-ps 0 0 0 0 0 0
