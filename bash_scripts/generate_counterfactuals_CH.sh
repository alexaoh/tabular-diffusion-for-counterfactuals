...
# Find possible counterfactuals from TabDDPM, after training the model. This finds possible counterfactuals from p(X,y).
nice python $DIR/../train_diffusion.py -s 1234 -d CH -T 1000 -e 200 -b 128 --mlp-blocks 512 1024 1024 1024 1024 512 --dropout-ps 0 0 0 0 0 0 --early-stop-tolerance 10 --dont-plot-losses --savename "TabDDPM_K10000_joint_" --num-samples 1000000 --dont-train
nice python $DIR/../train_diffusion.py -s 4500 -d CH -T 1000 -e 200 -b 128 --mlp-blocks 512 1024 1024 1024 1024 512 --dropout-ps 0 0 0 0 0 0 --early-stop-tolerance 10 --dont-plot-losses --savename "TabDDPM_K10000_joint_" --num-samples 1000000 --dont-train 
nice python $DIR/../train_diffusion.py -s 2018 -d CH -T 1000 -e 200 -b 128 --mlp-blocks 512 1024 1024 1024 1024 512 --dropout-ps 0 0 0 0 0 0 --early-stop-tolerance 10 --dont-plot-losses --savename "TabDDPM_K10000_joint_" --num-samples 1000000 --dont-train 
nice python $DIR/../train_diffusion.py -s 1999 -d CH -T 1000 -e 200 -b 128 --mlp-blocks 512 1024 1024 1024 1024 512 --dropout-ps 0 0 0 0 0 0 --early-stop-tolerance 10 --dont-plot-losses --savename "TabDDPM_K10000_joint_" --num-samples 1000000 --dont-train 
nice python $DIR/../train_diffusion.py -s 2023 -d CH -T 1000 -e 200 -b 128 --mlp-blocks 512 1024 1024 1024 1024 512 --dropout-ps 0 0 0 0 0 0 --early-stop-tolerance 10 --dont-plot-losses --savename "TabDDPM_K10000_joint_" --num-samples 1000000 --dont-train 
